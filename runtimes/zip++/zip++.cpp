...
namespace shared {
 ...
 bool Zip::zipCompress(__in const std::string& src, __out std::string& dest) {
  bool result = false;
  dest.clear();
  ...
  do {   
   ...
   if (Z_OK != compress(pCompress, &nCompress, (Bytef*)src.data(), static_cast<uLong>(src.size())))
    break;
 ...
 bool Zip::zipUnCompress(__in const std::string& src, __in const size_t& nraw, __out std::string& dest) {
  bool result = false;
  dest.clear();
  Bytef* pUnCompress = nullptr;
  do {
   pUnCompress = new Bytef[nraw];
   if (Z_OK != uncompress(pUnCompress, (uLongf*)&nraw, (Bytef*)src.data(), static_cast<uLong>(src.size())))
    break;
